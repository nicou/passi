...
/**
 * Luokka, jolla voi lähettää sähköpostia. Ota huomioon, että perusta tätä varten
 * dummy-tili gmailiin, jotta omat kredentiaalisi eivät vaarannu! Dummy tilin salasana
 * kannattaa vaihtaa kurssin suorittamisen jälkeen.
 * @author Jukka Juslin
 *
 */
